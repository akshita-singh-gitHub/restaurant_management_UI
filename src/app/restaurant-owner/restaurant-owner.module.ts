...
const RestaurantOwnerRoutes: Routes = [
  {
    path: '', children: [
      ...
      {
        path: 'RestoOwner', component: RestoOwnerComponent,
      ...
      {
        path: 'RestoOwner/updateFoodItem/:id', component: UpdateFoodItemComponent,
      ...
      {
        path: 'RestoOwner/addFoodItem', component: AddFoodItemComponent,
